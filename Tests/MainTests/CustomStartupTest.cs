...
namespace Tests.MainTests
{
    ...
    public class CustomStartupTest : BaseTestUsingStartupWithSecurity
    {
        [SetUp]
        ...
        public void DemoTest()
        {
            ...
            try
            {
                ...
                //Pass a custom startup class instead of the one in the ApplicationProject
                var startup = new CustomStartup(configuration);
